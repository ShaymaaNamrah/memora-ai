# Create a modern mobile-first AI flashcard app call
...
Open `ios/CreateAModernMobileFirstAIFlashcardAppCall.xcodeproj` in Xcode (16.0+, iOS 26 SDK) and
...
`app.10x.create-a-modern-mobile-first-ai-flashcard-app-call`
